...
echo "############################################################"
echo "Videos:"
echo "  .../videos/<setting>/   198 clips, named as the official evaluator expects."
echo "                          Hand one of these to the Physics-IQ repo unchanged."
echo "  .../videos/few_step/    the 2-step generations the priors come from -- the prior"
echo "                          in RGB. Written once, and kept out of the setting"
echo "                          directories because the evaluator counts the files there."
echo ""
echo "Compare every setting:"
echo "  python scripts/report_guidance.py $ROOT/$RUN_ID"
